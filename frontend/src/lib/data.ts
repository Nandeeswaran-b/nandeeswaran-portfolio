...
export const projects = [
  ...
  },
  {
    ...
    subtitle: 'Power BI Business Intelligence Platform',
    description: 'Consolidated records from disparate corporate files into a unified dashboard, building custom KPI indicators, sales trends, and regional drilldowns.',
    ...
    githubLink: 'https://github.com',
    tags: ['Power BI', 'DAX', 'ETL', 'Power Query'],
    challenge: 'Corporate stakeholders lacked immediate clarity on regional sales distributions and product category margins due to fragmented data files (CSVs, Excel sheets) stored across multiple departments.',
    methodology: 'Engineered an automated ETL pipeline using Power Query to clean, merge, and transform raw records. Designed a star-schema data model in Power BI and wrote advanced DAX measures to calculate Year-over-Year (YoY) metrics and margin KPIs.',
    impact: 'Allowed leadership to identify and address low-performing regional distributors within 2 minutes. Empowered the logistics team to reallocate high-margin inventory, resulting in a 7% reduction in warehousing times.',
    details: {
      keyMetric: 'Data Source Sync Time',
      keyMetricVal: 'Real-time (Scheduled)',
      modelType: 'Power BI + DAX Model',
